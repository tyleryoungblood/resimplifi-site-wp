...
$args = array(
    ...
    <div class="row">
		<?php if ($loop->max_num_pages > 1) : ?>
            <nav class="post-nav">
                <ul class="pager">
                    <li class="previous"><?php next_posts_link(esc_html__('&larr; Previous', 'stratus'), $loop->max_num_pages); ?></li>
                    <li class="next"><?php previous_posts_link(esc_html__('Next &rarr;', 'stratus'), $loop->max_num_pages); ?></li>
                </ul>
            </nav>
        <?php endif; ?>
	</div>
