...
final class User extends Component {
	 ...
	 * @param \WP_User $user
	 */
	public function callback_profile_update( $user_id, \WP_User $user ) {
	 ...
	 */
	public function callback_set_user_role( $user_id, $new_role, array $old_roles ) {
	 ...
	 * @param \WP_User $user
	 */
	public function callback_wp_login( $user_login, \WP_User $user ) {
	 ...
	 * @param \WP_User $user
	 */
	public function callback_password_reset( \WP_User $user ) {
