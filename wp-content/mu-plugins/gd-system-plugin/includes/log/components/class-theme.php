...
final class Theme extends Component {
	 ...
	 */
	public function callback_switch_theme( $new_name, \WP_Theme $new_theme, \WP_Theme $old_theme ) {
	 ...
	 * @param array           $data
	 */
	public function callback_upgrader_process_complete( $upgrader, array $data ) {
	 ...
	 * @param \Theme_Upgrader $upgrader
	 */
	private function theme_install( \Theme_Upgrader $upgrader ) {
