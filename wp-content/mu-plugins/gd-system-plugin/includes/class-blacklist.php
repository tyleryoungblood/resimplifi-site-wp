...
final class Blacklist {
	...
	public function __construct( API_Interface $api ) {
		...
		$this->blacklist = $api->get_blacklist();
	...
	public function admin_enqueue_scripts( $hook ) {
		...
		wp_enqueue_style( 'wpaas-tip', Plugin::assets_url( "css/jquery-tip{$suffix}.css" ), [], Plugin::version() );
	...
	private function is_blacklisted( $plugin ) {
		...
		foreach ( $this->blacklist as $blacklisted_plugin ) {
