...
final class Image_API {
	...
	public function get_d3_categories_fallback() {
		...
		$list = [
			'professional'                 => __( 'Business / Finance / Law', 'wpaas-stock-photos' ),
			'graphicdesign'                => __( 'Design / Art / Portfolio', 'wpaas-stock-photos' ),
			'education'                    => __( 'Education', 'wpaas-stock-photos' ),
			'health'                       => __( 'Health / Beauty', 'wpaas-stock-photos' ),
			'constructionservices'         => __( 'Home Services / Construction', 'wpaas-stock-photos' ),
			'massmedia'                    => __( 'Music / Movies / Entertainment', 'wpaas-stock-photos' ),
			'non-charitableorganizations'  => __( 'Non-profit / Causes / Religious', 'wpaas-stock-photos' ),
			'generic'                      => __( 'Other', 'wpaas-stock-photos' ),
			'pets'                         => __( 'Pets / Animals', 'wpaas-stock-photos' ),
			'realestate'                   => __( 'Real Estate', 'wpaas-stock-photos' ),
			'restaurants'                  => __( 'Restaurant / Food', 'wpaas-stock-photos' ),
			'active'                       => __( 'Sports / Recreation', 'wpaas-stock-photos' ),
			'auto'                         => __( 'Transportation / Automotive', 'wpaas-stock-photos' ),
			'hotelstravel'                 => __( 'Travel / Hospitality / Leisure', 'wpaas-stock-photos' ),
			'weddingphotographers'         => __( 'Wedding', 'wpaas-stock-photos' ),
		];
